...
export async function posts(
  ...
  const flags = parseArgs<PostsFlags>(args, {
    flags: {
      ...PAGINATION,
      ...RAW,
  ...
  if (flags.status !== undefined) params.status = flags.status;
  if (flags.contentTags !== undefined) params.content_tags = flags.contentTags;
  if (flags.authors !== undefined) params.authors = flags.authors;
  if (flags.audience !== undefined) params.audience = flags.audience;
  if (flags.platform !== undefined) params.platform = flags.platform;
  ...
  if (flags.slugs !== undefined) params.slugs = flags.slugs;
  if (flags.hiddenFromFeed !== undefined) params.hidden_from_feed = flags.hiddenFromFeed;
